...
st.set_page_config(page_title="Cashew C-Suite Dashboard", layout="wide")
...
st.title("Cashew C-Suite Dashboard")
...
with chart_col2:
    ...
    age_band_colors = {
        'Young (<35)': '#4CAF50',        # Green
        'Middle-Aged (35-55)': '#2196F3', # Blue
        'Senior (55+)': '#FF9800'         # Orange
    }
...
with chart_col3:
    ...
    if 'marketing_spend_sgd' in events.columns and 'attributed_sales_sgd' in events.columns and 'channel_type' in events.columns:
        ...
        fig_roms = px.bar(
            ...
            color_discrete_map={'Online': "#0F0C61"},
